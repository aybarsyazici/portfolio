...
export const checkDownload = (
  ...
  rerender && // is submitted
  currentCommand.length === 1 && // current command has no arg
  currentCommand[0] === "cv"; // current command is 'cv'
...
export const argTab = (
  ...
  // 8) if input is 'projects go '
    ...
    [
      ...
      "2.Time series student performance prediction",
      "3.Brain Fingerprinting via Graph Structure Learning",
